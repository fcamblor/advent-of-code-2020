...
test('should fixing instructions in Q2 perform correctly', () => {
    const instructions = [
        ["nop", "+0" ],
        ["acc", "+1" ],
        ["jmp", "+4" ],
    ...
    expect(InstructionExecutor.createFrom(instructions).tryExecuteByFixingInstructions().state.accumulator).toEqual(8);
})
