...
import {BIT_VALUE, D14Mask, MASK_VALUE, q14Read, q14Solve, totalMemoryOf} from "../src/2020-14";


test("Q1 samples", () => {
    expect(new D14Mask("XXXXXXXXXXXXXXXXXXXXXXXXXXXXX1XXXX0X".split("") as MASK_VALUE[])
