...
export const Q1_STARTING_SAMPLE = `
L.LL.LL.LL
LLLLLLL.LL
L.L.L..L..
LLLL.LL.LL
...
export const Q1_EXPECTED_ROUNDS = [{
        stabilized: false, raw:`
#.##.##.##
#######.##
#.#.#..#..
####.##.##
...
export const Q2_SEATS_COUNT_SAMPLES = [{
        expected: 8, x:3, y:4, rawSeats: `
.......#.
...#.....
.#.......
.........
...
`.trim()
        ...
        expected: 0, x:1, y:1, rawSeats: `
.............
.L.L.#.#.#.#.
.............
`.trim()
    }, {
        expected: 0, x:3, y:3, rawSeats: `
.##.##.
#.#.#.#
##...##
...L...
...
export const Q2_EXPECTED_ROUNDS = [{
    stabilized: false, raw:`
#.##.##.##
#######.##
#.#.#..#..
...
export const Q2_STARTING_SAMPLE = `
L.LL.LL.LL
LLLLLLL.LL
L.L.L..L..
LLLL.LL.LL
